...
const WhyChooseUs = () => {
  const reasons = [
    { title: "Personalized Nutrition Plans", description: "Tailored diet plans based on your health goals, lifestyle, and preferences to achieve sustainable results.", icon: <Shield className="w-8 h-8" />, color: "bg-orange-50", iconColor: "text-orange-500" },
