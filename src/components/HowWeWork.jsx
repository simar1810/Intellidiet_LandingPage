...
const TestimonialSlideshow = () => {
  ...
  return (
    <div className="relative h-full min-h-[300px] md:min-h-[400px] rounded-2xl flex items-center justify-center p-4">
      ...
      {/* Removed navigation dots below the images */}
    </div>
  );
};
...
const HowWeWork = () => {
  return (
    <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-b from-[#faf6f4] to-white" id="how-we-work">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="/contact-us"
                className="inline-flex items-center justify-center bg-[#54151B] hover:bg-[#7a1f2e] text-white px-8 py-3 rounded-xl font-bold transition-all hover:shadow-lg"
              >
                Book Appointment
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="text-center p-4 bg-[#faf6f4] rounded-xl">
