  ...
  {/* Right Side Image */}
     <div className="w-full md:w-1/2 flex justify-center items-center">
        <img
          ...
          className="w-full h-auto max-w-lg rounded-xl shadow-lg"
        />
    </div>
  </section>
      ...
      <section className="flex flex-col md:flex-row gap-10 py-20 px-5 md:px-20 bg-[#92BC34] text-[#1B5C24]">
        ...
        {/* Info Panel */}
        <div
          className="flex-1 bg-[#ECBE59] p-10 rounded-xl shadow-lg"
        >
        ...
        <form
          ...
          className="flex-1  p-10 rounded-xl shadow-lg space-y-5 relative overflow-visible"
        >
          ...
          <button
            ...
            className="w-full mt-4 p-4 h-10 rounded-xl bg-green-900 text-white font-bold text-center hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-700 border-none appearance-none transition-colors shadow-md"
          >
            Submit
          </button>
        </form>
