                                    ...
                                    */}
                                    <div className="mt-auto pt-4 border-t border-gray-100 flex flex-row items-center justify-between gap-4">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center gap-2 bg-secondary hover:bg-orange-600 text-white font-bold px-6 py-3 rounded-xl text-sm sm:text-base shadow-lg hover:shadow-orange-400/30 transition-all duration-300 hover:-translate-y-0.5 active:scale-95 whitespace-nowrap"
                                        >
                                            Order Now
