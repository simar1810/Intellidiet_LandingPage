    ...
    <main className="min-h-screen flex flex-col bg-[#FAFAFA]">
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-8 sm:p-12 space-y-6 text-gray-700 leading-relaxed">
        ...
        <p>
          ...
          use of {appName}&apos;s website, located at
          {" "}
          <span className="font-semibold">intellidiet.com</span>.
        </p>
        ...
        <p>
          ...
          sending an email to{" "}
          <span className="font-semibold">garimars1@gmail.com</span>. Please
